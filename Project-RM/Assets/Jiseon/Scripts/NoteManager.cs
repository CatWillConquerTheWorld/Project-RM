...
public class NoteManager : MonoBehaviour
{
    ...
    public void resetLongNote(GameObject longNote)
    {
        ...
        if (parentGameObject != null)
        {
            parentGameObject.transform.position = tfLongNoteAppear.position;
            timingManager.boxNoteList.Remove(parentGameObject.gameObject);
            longnote3 pooledLongNote = parentGameObject.GetComponent<longnote3>();
            ObjectPool.instance.ReturnLongNote(parentGameObject.gameObject, pooledLongNote != null && pooledLongNote.isEnemyLongNote);
        }
    }
    ...
    public void MakeLongNote()
    {
        ...
        longnote3.isEnemyLongNote = false;
